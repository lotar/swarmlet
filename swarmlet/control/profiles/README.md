...
| `coordinatorHostMiB` | 32768 (32 GiB) | PLE n-gram table 28.8 GiB mmap-backed on CPU (`-ot ple_ngram_embd=CPU`, control-plane doc §6 table) plus KV cache and scratch at ctx 1536 × parallel 3 |
