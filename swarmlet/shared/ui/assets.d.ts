declare module "*processing.js" { const text: string; export default text; }
declare module "*processing.css" { const text: string; export default text; }
declare module "*markdown.js" { const text: string; export default text; }
